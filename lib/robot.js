...
function Robot(name, serial, secret, token) {
    ...
    this._nucleoBaseUrl = 'https://nucleo.ksecosys.com/vendors/vorwerk/robots/';
    //this._beehiveBaseUrl = 'https://beehive.neatocloud.com/users/me/robots/';
    this._beehiveBaseUrl = 'https://vorwerk-beehive-production.herokuapp.com/users/me/robots/';
    this.name = name;
    this._serial = serial;
    this._secret = secret;
    this._token = token;
